...
GamePlayManager = {
    ...
    create: function() {
        ...
        this.scoreText = game.add.text(game.width/2, 40, 'Puntaje: 0', style);
        this.scoreText.anchor.setTo(0.5);

        this.totalTime = 30;
        this.timerText = game.add.text(1000, 40, 'Tiempo: 30', style);
    ...
    increaseScore:function() {
        ...
        this.scoreText.text = 'Puntaje: ' + this.currentScore;
